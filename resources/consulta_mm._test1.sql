...
SELECT Usuario, (c+d+e+f+g+h+i+j+k+l) as Suma FROM 
(SELECT a.Usuario, 
...
FROM mm_test1 a, (SELECT * FROM mm_test1 WHERE Usuario = '14240343') b) m
WHERE Usuario != '14240343' ORDER BY Suma DESC
