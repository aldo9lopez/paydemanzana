<?php
    if(isset($_POST["enviar-2"])){
        try{
            ...
            if($mov>0){
                $query="UPDATE mm_test2 SET Q1=:q1,Q2=:q2,Q3=:q3,Q4=:q4,Q5=:q5,Q6=:q6,Q7=:q7,Q8=:q8,Q9=:q9,Q10=:q10 WHERE Usuario=:usuario";
                $resultado=$base->prepare($query);
                ...
                $query="INSERT INTO mm_test2 VALUES(:usuario,:q1,:q2,:q3,:q4,:q5,:q6,:q7,:q8,:q9,:q10)";
                $resultado=$base->prepare($query);
